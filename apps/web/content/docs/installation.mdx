...
ScreenshotsMCP works with any client that supports the **Model Context Protocol (MCP)**. Here's how to configure each one.
...
Once connected, your AI assistant has access to **28 tools**:
