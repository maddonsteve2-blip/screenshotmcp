...
3. Install or repair the managed core ScreenshotsMCP skill in `~/.agents/skills/screenshotsmcp`

Use this path when you want the fastest way to get browser truth into your IDE, CLI, or MCP workflow.
